...
#define OSC_FREQ		27
	...
	#define DDR_PLL_796	
	#elif defined(CONFIG_TI816X_DDR3_675)
	#define DDR_PLL_675	
	#elif defined(CONFIG_TI816X_DDR3_661)
	#define DDR_PLL_661
	#elif defined(CONFIG_TI816X_DDR3_648)
	#define DDR_PLL_648
	#elif defined(CONFIG_TI816X_DDR3_531)
	#define DDR_PLL_531	
	#elif defined(CONFIG_TI816X_DDR3_400)
	#define DDR_PLL_400
	#else
	#warning "Unsupported DDR3 clock speed, selecting default 400MHz"
...
#define DDR_INTFREQ2		9
#define DDR_FRACFREQ2		0x300000
#define DDR_MDIV2		0x18
